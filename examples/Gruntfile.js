    ...
    grunt.initConfig({
                ...
                options: {
                    middleware: function(connect) {
                        return [
                            ...
                            connect().use('/js/gnap', connect.static('./node_modules/gnap-theme-gnap-angular/js/gnap')),
                            connect().use('/js/angular', connect.static('./node_modules/gnap-theme-gnap-angular/js/angular'))
                        ];
                    }
                }
            },
            ...
            dist: {
                files: [
                    ...
                    },
                    {
                        expand: true,
                        dot: true,
                        cwd: 'node_modules/gnap-theme-gnap-angular',
                        dest: './dist/vendor',
                        src: [
                            './fonts/*.*',
                            './images/*.*',
        ...
        replace: {
            ...
            dist: {
                ...
                replacements: [
                    {
                        from: 'node_modules/gnap-theme-gnap-angular/images/',
                        to: 'vendor/images/'
                    },
                    {
                        from: 'url("../../fonts',
